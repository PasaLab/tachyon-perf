package tachyon.perf.datagen;

import java.util.ArrayList;
import java.util.List;
import java.util.Random;

import tachyon.perf.ReadMode;
...
public class ListGenerator {
   ...
   * 
   * @param threadsNum
   *          number of the read threads
   * @param filesPerThread
   *          number of the read files of each read thread
   * @param candidates
   *          all the read file candidates' id
   * @param readMode
   *          read mode of the read test
   * @param identical
   *          true means all the read threads use the same list
   ...
   * 
   * @param threadsNum
   *          number of the write threads
   * @param filesPerThread
   *          number of the write files of each write thread
   * @param dirPrefix
   *          the workspace path of the write test in Tachyon File System
